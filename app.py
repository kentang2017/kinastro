...
from ui.system_handlers.homepage_handler import (
    inject_star_particles as _inject_star_particles,
    render_homepage,
    render_reference_library as _render_reference_library,
)
    ...
    *,
    ...
    try:
        ...
        if after_chart_hook:
            ...
            if "after_chart_hook" in _render_params or any(
