...
![Systems](https://img.shields.io/badge/Systems-78-FFD700?style=for-the-badge)
...
| | 中文 | English |
|---|---|---|
| 🔮 **七十八體系合一** | 在同一個介面中切換七十八種占星體系，無需來回切換工具 | Switch between 78 astrology systems in one unified interface |
...
> 💡 體系按分類顯示：熱門 → 三式 → 中國 → 西方 → 印度 → 亞洲 → 中東 · 北非 → 古代文明 → 醫占 (含拜占庭占星) → 傳統卜卦占星 → 擇日占星；目前清單已與側邊欄同步，納入馬來伊斯蘭占星 Bintang Duabelas（十二星）、地占占星（Astronomical Geomancy）、伊特魯里亞占星（Etruscan Astrology）、吠陀風水（Vastu Shastra）、歐洲地占（European Geomancy）、弗拉德命運輪盤（Fludd Rota Simulator）、煉金占星（Alchemical Astrology）與衣索比亞 Bahre Hasab（Ethiopian Bahre Hasab）
>
> *Systems displayed by category: Popular → Three Formulae → Chinese → Western → Indian → Asian → Middle East & North Africa → Ancient → Medical Astrology (incl. Byzantine Astrology) → Traditional Horary → Electional; the list is now aligned with the sidebar and includes Bintang Duabelas (Twelve Stars), Astronomical Geomancy, Etruscan Astrology, Vastu Shastra, European Geomancy, Fludd Rota Simulator, Alchemical Astrology, and Ethiopian Bahre Hasab*
...
| 17 | ⭐ 北極神數 Beiji Shenshu | 農曆 Lunar | 北斗七星破軍星・奇門九星・六十四卦・二十八宿・區分同八字異命 |
| 18 | ☰ 南極神數 Nanji Shenshu | 農曆 Lunar | 四柱八字・二十八宿・建除十二辰・246條手稿條文・五大神數之一 |
| 19 | 🀄 子平八字 Ziping Bazi | 農曆 Lunar | 四柱八字・十神格局・用神・大運・傳統水墨命盤 SVG |
| 20 | 🌀 滌器遺訣 Diqiyijue | 農曆 Lunar | 邵子氣數・三大分析分頁・流年推演・古訣對照 |
| 21 | ☵ 蠢子數 ChunZiShu | 農曆 Lunar | 二十八宿・七政四餘・度數詩詞・4574 筆命例・女命婚姻子息推算 |
| | **🏛️ 西方 Western** | | |
| 22 | 🏺 希臘 Hellenistic | 回歸 Tropical | Greek Lots・Egyptian Bounds・Profections・Zodiacal Releasing・擴充 Lots・Valens Synkrasis・百論 |
| 23 | ✡ 卡巴拉 Kabbalah | 回歸 Tropical | 生命之樹・希伯來字母・塔羅 |
| 24 | ✡ 猶太 Mazzalot | 恆星 Sidereal | 大衛之星盤・十二支派・Sefer Yetzirah 字母 |
| 25 | 🗺️ Astrocartography 地點占星 | 回歸 Tropical | AC/MC/IC/DC 搬遷線・互動 Plotly 地圖・過運搬遷線 |
| 26 | ♅ 天王星漢堡學派 Uranian | 回歸 Tropical | 8 超海王星虛點・90° 度盤・中點樹・行星圖像 |
| 27 | 🌟 Sabian Symbols | 回歸 Tropical | 360 度符號・Marc Edmund Jones 原著・SVG 視覺化・關鍵字解讀 |
| 28 | 🌳 凱爾特樹木曆 Celtic Tree Calendar | 回歸 Tropical | 13 月樹曆・Beth-Luis-Nion 體系・歐甘文字・凱爾特守護樹 |
| 29 | 🔬 宇宙生物學 Cosmobiology (Ebertin) | 回歸 Tropical | Ebertin 中點樹・90° 轉盤・COSI 行星組合詮釋・合盤比對 |
| 30 | 🔮 出生時間校正 Rectification | 回歸 Tropical | 初級方向・太陽弧・次進法・流年小限・黃道釋放・加權評分 |
| 31 | 🎵 和諧占星 Harmonic Astrology | 回歸 Tropical | John Addey 諧波・H5 才能・H7 靈性・H9 進化・神聖幾何曼陀羅 |
| 32 | ⚷ 古典主限推運 Primary Directions | 回歸 Tropical | Placidus 世間主限・Ptolemy 黃道主限・奈包德時間鍵・順向/逆向主限 |
| 33 | ☿ 赫密士前世盤 Trutine of Hermes | 回歸 Tropical | 托勒密《百句箴言》・出生前世盤・月亮↔上升互換・靈魂入身印記 |
| 34 | ✨ 靈性占星 Esoteric Astrology (Seven Rays) | 回歸 Tropical | Alice Bailey 七道光線・靈魂光線・靈性統治星・七芒星曼陀羅 |
| 35 | ☯ 人間圖 Human Design | 回歸 Tropical | Ra Uru Hu・類型/策略/權威・九大中心・BodyGraph・閘門/通道 |
| 36 | 🌍 世俗占星 Mundane Astrology | 回歸 Tropical | 國家／城市星盤・Ingress 季節盤・日月食政治事件・世界大事週期分析 |
| 37 | ⚙ 弗拉德命運輪盤 Fludd Rota Simulator | 回歸 Tropical | 文藝復興同心圓命運輪盤・四環旋轉機制・行星度數驅動 |
| 38 | ⚗️ 煉金占星 Alchemical Astrology | 回歸 Tropical | 帕拉塞爾蘇斯傳統・七大行星金屬草藥礦物對應・符號論・四大煉金階段・Opus Magnum |
| | **🪷 印度 Indian** | | |
| 39 | 🙏 印度占星 Vedic | 恆星 Sidereal | 星座盤・大運 Dasha・Ashtakavarga・Yogas・BPHS・Varga 分盤 |
| 40 | 🔱 納迪 Nadi | 恆星 Sidereal | 三大脈輪・27 星宿・納迪宮分 |
| 41 | 🕉️ 闍彌尼 Jaimini | 恆星 Sidereal | Chara Karaka・Rashi Drishti・Argala・Arudha Pada・Chara Dasha |
| 42 | 🔮 KP 占星 Krishnamurti Paddhati | 恆星 Sidereal | Rasi/Star/Sub Lords・Ruling Planets・Significators・Horary 問卜・北印度鑽石盤 |
| 43 | 📕 紅皮書占星 Lal Kitab | 恆星 Sidereal | 業力化解 Upay・十二宮祕方・行星補救・35 年生命週期・手紋 |
| 44 | 🪔 吠陀風水 Vastu Shastra | 恆星 Sidereal | 八方位吉凶・Vastu Purusha Mandala・五行平衡・空間評分 |
| | **🌏 亞洲 Asian** | | |
| 45 | 🈳 宿曜道 Sukkayodo | 恆星 Sidereal | 二十八宿・六曜・方盤 |
| 46 | 🐘 泰國占星 Thai | 恆星 Sidereal | 泰式盤面・九宮格占卜・พรหมชาติ |
| 47 | 🇲🇲 緬甸 Mahabote | 星期制 Weekday | 八方位・七宮・行星大運 |
| 48 | 🏝️ 巴厘 Wariga | 巴厘曆 Wuku | Wuku 210 天週期・Wewaran 九層週期・Neptu 數值・吉凶判斷 |
| 49 | 🇲🇳 祖爾海 Zurkhai | 藏曆 Tibetan | 12 生肖・五行・擇吉 |
| 50 | 🏔️ 藏傳時輪金剛 Tibetan | 藏曆 Tibetan | Mewa 九宮・Parkha 八卦・五力系統・時輪金剛曼荼羅 |
| 51 | 🌟 九星氣學 Nine Star Ki | 洛書 Lo Shu | 本命星・月命星・日命星・五行・洛書九宮・相性分析 |
| 52 | 🔮 土亭數 Tojeong Shu | 農曆 Lunar | 先天數後天數・格局代碼・129 格局斷語・三元 |
| 53 | 🇰🇭 高棉占星 Khmer Astrology | 數理 Numerology | Reamker 史詩・32 格預言・八大命主・羅摩之箭・bè 祭壇儀式 |
| 54 | 🏺 爪哇 Weton / Primbon | 爪哇曆 Javanese | Saptawara×Pancawara・Neptu 值・合婚計算・35 天 Weton 週期・Primbon 本命詳解 |
| 55 | ⭐ 馬來伊斯蘭占星 Bintang Duabelas（十二星） | 數理 Numerology | Jawi Abjad・Hisab Nama・十二星宮・行星時辰・Azimat |
| 56 | 🌺 波利尼西亞／夏威夷 Polynesian / Hawaiian | 恆星 Sidereal | 星辰知識・32 方位羅盤・Hōkūleʻa 守護宮位・導航星術 |
| | **☪ 中東 · 北非 Middle East & North Africa** | | |
| 57 | ☪ 阿拉伯 Arabic | 回歸 Tropical | 阿拉伯點・Picatrix 星體魔法・太陽知識大全・MS164 手稿 |
| 58 | 🕌 也門 Yemeni | 恆星 Sidereal | 28 月宿護符魔法・Anwāʼ 天氣預兆・Firdaria 週期 |
| 59 | 🏛️ 薩珊波斯 Sassanian Persian | 恆星 Sidereal | 菱形 12 宮星盤・Firdar 生命週期・Hyleg/Alcocoden・皇家恆星・Profections・Almuten・阿拉伯點 |
| 60 | 🏛️ 薩珊波斯進階版 Sassanian Persia (Advanced) | 恆星 Sidereal | 正確 Firdaria 序列・Hyleg/Alcocoden 三範圍・多德卡特摩里亞・反射點・14 阿拉伯點 |
| 61 | ✦ Picatrix 占星魔法 Picatrix Star Magic | 回歸 Tropical | 15 顆 Behenian 根源恆星・護符圖像・寶石草藥・星盤激活偵測 |
| 62 | ⵣ 柏柏爾占星 Amazigh Astrology | 恆星 Sidereal | 七曜・固定星・Lots 命運點・四方位季節象徵・北非柏柏爾星空傳統 |
| 63 | 🇪🇹 衣索比亞 Bahre Hasab | 衣索比亞曆 Ethiopian | 衣索比亞傳統曆法・太陽月亮週期・節日計算・聖徒紀念日・科普特傳統 |
| 64 | 🔮 地占占星 Astronomical Geomancy | — | 隨機點數・16 地占圖形・12 宮排列・占星格局判斷 |
| | **🏺 古代文明 Ancient** | | |
| 65 | 🏺 瑪雅 Maya | 瑪雅曆 Maya Cal. | Tzolkin・Haab・Long Count |
| 66 | 🌿 印加／安地斯占星 Andean Cosmology | 文化宇宙學 Cosmology | Ceque 聖地線路・南十字 Chakana・昴宿星農曆觀測 |
| 67 | 🦅 阿茲特克 Aztec | 阿茲特克曆 | Tonalpohualli・Trecena・守護神祇 |
| 68 | 🏛️ 古埃及 Decans | 回歸 Tropical | 36 Decans・塔羅・Dendera 輪盤圖 |
| 69 | 🏛️ 巴比倫 Babylonian | 恆星 Sidereal | MUL.APIN 星表・K.8538 星盤・Enūma Anu Enlil 預兆 |
| 70 | 🜂 多貢天狼星宇宙學 Dogon Sirius Cosmology | 文化宇宙學 Cosmology | Sirius A/B/C（Po Tolo／Emme Ya）・Sigui 50 年週期・跨文化比較 |
| 71 | 𒀭 蘇美/美索不達米亞 Sumerian / Mesopotamian | 恆星 Sidereal | MUL.APIN 星表・Enūma Anu Enlil 預兆・K.8538 尼尼微星盤・七大行星神 |
| 72 | 🏺 伊特魯里亞占星 Etruscan Astrology | — | 皮亞琴察青銅肝臟・天宮十六區（Templum XVI）・閃電占卜・haruspicy |
| | **⚕️ 醫占 Medical Astrology** | | |
| 73 | ✚ 拜占庭占星 Byzantine Astrology | 回歸 Tropical | 政治星盤（皇帝・城市・宗教）・地震占・月行占・雷鳴占・基督教占星融合・赫費斯提翁傳統 |
| 74 | ⚕️ 醫學占星 Medical Astrology | 回歸 Tropical | 黃道人體質分析・四液質・埃及三十六旬星身體對照・療癒擇時・疾病危機日計算 |
| 75 | 🌿 傷寒鈐法 Shanghan Qianfa | 農曆 Lunar | 六經辨證・干支鈐法推算・六經歸屬・經方推薦・傳經預後 |
| | **📜 傳統卜卦占星 Traditional Horary Astrology** | | |
| 76 | 📜 傳統卜卦占星 Traditional Horary | 回歸 / 恆星 | 西洋卜卦（Lilly/Bonatti）・吠陀問卜（Prashna Marga）・嚴格限制（Strictures）・應期推算・問題徵象主・問卜星盤 |
| 77 | 🜃 歐洲地占 European Geomancy | — | 16 地占圖形・Shield Chart・House Chart・Judge 判決位 |
| | **⏳ 擇日 Electional** | | |
| 78 | ⏳ 擇日占星 Electional / Muhurta | 回歸 / 恆星 | 西方 Lilly/Bonatti 擇日・行星時・吠陀五曆・婚姻擇日・Panchanga・最佳吉時搜尋 |
...
<details>
<summary><strong>⭐ 馬來伊斯蘭占星（Bintang Duabelas / 十二星）</strong></summary>

源自馬來世界與伊斯蘭手稿傳統的數理占星工具箱，結合 Jawi／阿拉伯字母數值、十二星宮、行星時辰與護符實務。

*A Malay-Islamic manuscript tradition toolkit combining Jawi/Arabic letter numerology, twelve-star houses, planetary hours, and practical talisman work.*

- **Abjad / Jawi 數值**：把阿拉伯字母、Jawi 或常見 Romanized 姓名轉換為數值總和 — Convert Arabic, Jawi, or common romanized names into Abjad totals
- **Hisab Nama**：以餘數法推算疾病來源、失蹤占、婚姻相合與胎兒占 — Modular remainder divination for illness source, missing-person, marriage, and fetal readings
- **十二星宮 / Twelve Star Houses**：由本人與母親姓名決定所屬星宮與十二宮位 — Derive the star-sign house from the querent and mother-name totals
- **行星時辰 / Planetary Hours**：依星期、日夜與日出日落切換吉凶時段 — Compute auspicious or difficult hours from weekday day/night sequences
- **Azimat**：依目的提供護符文字、建議時機與簡要使用指引 — Offer talisman formulas, timing hints, and practical notes by purpose

> 📖 此模組以文化、文獻與民俗實務整理為主，供研究、學習與傳統方法比較參考。
>
> *This module is presented for cultural, manuscript, and folk-practice study, useful for learning and comparative traditional research.*
...
<details>
<summary><strong>✚ 拜占庭占星（Byzantine Astrology）</strong></summary>

源自東羅馬帝國（公元4–15世紀）的占星傳統，融合希臘化與阿拉伯技法，涵蓋政治星盤、基督教-占星融合、自然預兆占卜。

*The astrological tradition of the Eastern Roman Empire (4th–15th century CE), bridging Hellenistic and Arabic techniques, covering political horoscopes, Christian-astrological syncretism, and omen divination.*

- **政治星盤 / Political Horoscopes**：皇帝即位、城市奠基、宗教事件的星盤推算 — Horoscopes for imperial enthronements, city foundations, and religious events
- **地震占 Seismologia**：以星象推算地震時機與烈度徵兆 — Earthquake timing and intensity omens from planetary positions
- **月行占 Selenodromia**：月相週期預兆分析 — Moon phase cycle omen analysis
- **雷鳴占 Vrontologia**：雷鳴聲方位與行星對應的預兆體系 — Thunder direction and planetary correspondence omen system
- **主要文獻**：赫費斯提翁（Hephaestion of Thebes）、保羅·亞歷山大里亞（Paulus Alexandrinus）、雷托里烏斯（Rhetorius）、埃德薩的塞奧菲盧斯（Theophilus of Edessa）、約翰·阿布拉米烏斯（John Abramius）
