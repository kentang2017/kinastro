...
![Systems](https://img.shields.io/badge/Systems-52-FFD700?style=for-the-badge)
...
| | 中文 | English |
|---|---|---|
| 🔮 **五十二體系合一** | 在同一個介面中切換五十二種占星體系，無需來回切換工具 | Switch between 52 astrology systems in one unified interface |
...
>
> *Systems displayed by category: Popular → Three Formulae → Chinese → Korean → Khmer → Western → Indian → Asian → Middle East → Ancient → Medical Astrology → Traditional Horary*
...
| 52 | 📜 傳統卜卦占星 Traditional Horary Astrology | 回歸 Tropical | William Lilly 卜卦・Bonatti 問卜・VOC 月亮・光的傳遞・Vedic Prashna 問卜・Arudha Lagna |
