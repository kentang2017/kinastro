...
""",
    ...
    "western_subtab_love_synastry": {"zh": "❤️ 愛情合盤", "zh_cn": "❤️ 爱情合盘", "en": "❤️ Love Synastry"},
    "love_synastry_header": {"zh": "❤️ 愛情合盤分析", "zh_cn": "❤️ 爱情合盘分析", "en": "❤️ Love Synastry Analysis"},
    "love_synastry_name_a": {"zh": "你的名字", "en": "Your name"},
    "love_synastry_name_b": {"zh": "對方名字", "en": "Partner's name"},
    "love_synastry_person_b": {"zh": "對方出生資料", "en": "Partner Birth Data"},
    "love_synastry_calculate": {"zh": "💘 計算愛情合盤", "en": "💘 Calculate Love Synastry"},
    "love_synastry_calculating": {"zh": "💘 計算愛情合盤中…", "en": "💘 Calculating love synastry…"},
    "love_synastry_name_a_default": {"zh": "你", "en": "You"},
    "love_synastry_name_b_default": {"zh": "對方", "en": "Partner"},
    "love_synastry_all_aspects": {"zh": "全部愛情相位", "en": "All love aspects"},
    "love_synastry_scores": {"zh": "💕 愛情指數", "en": "💕 Love Scores"},
    "love_synastry_attraction": {"zh": "吸引力 & 化學反應", "en": "Attraction & Chemistry"},
    "love_synastry_emotional": {"zh": "情感連結", "en": "Emotional Bond"},
    "love_synastry_sexual": {"zh": "性張力", "en": "Sexual Chemistry"},
    "love_synastry_longterm": {"zh": "長期發展潛力", "en": "Long-term Potential"},
    "love_synastry_overall": {"zh": "綜合愛情指數", "en": "Overall Love Index"},
    "love_synastry_aspects": {"zh": "💫 愛情關鍵相位", "en": "💫 Key Love Aspects"},
    "love_synastry_overlays": {"zh": "🏠 愛情宮位疊加", "en": "🏠 Love House Overlays"},
    "love_synastry_composite": {"zh": "⭐ 複合盤核心行星", "en": "⭐ Composite Core Planets"},
    "love_synastry_summary": {"zh": "💌 浪漫故事總結", "en": "💌 Romantic Story"},
    "love_synastry_advice": {"zh": "🌹 愛情建議", "en": "🌹 Love Advice"},
