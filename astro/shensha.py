...
DIYUAN_LU = {k: (v + 6) % 12 for k, v in TIANYUAN_LU.items()}
RENYUAN_LU = {k: (v + 3) % 12 for k, v in TIANYUAN_LU.items()}
TIANJING = {0: 5, 1: 6, 2: 8, 3: 9, 4: 8, 5: 9, 6: 11, 7: 0, 8: 2, 9: 3}
DIWEI = {k: (v + 6) % 12 for k, v in TIANJING.items()}
