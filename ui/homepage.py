    ...
    _categories = [
        ...
        ("🏛️", "西洋占星", "Western Astrology",
         ["西洋占星", "薩比安符號", "希臘化占星", "星移地圖", "天王星漢堡", "宇宙生物學", "和諧占星",
          "古典主限推運", "凱爾特樹", "出生時間校正", "赫密士前世盤", "靈性占星", "伊諾克占星",
          "所羅門占星", "拜占庭占星", "人間圖", "世俗占星", "弗拉德命運輪盤", "煉金占星"],
        ...
        ("🌏", "亞洲體系", "Asian Systems",
         ["土亭數", "宿曜道", "泰國占星", "老撾占星", "緬甸 Mahabote", "峇里 Wariga", "爪哇 Weton", "馬來伊斯蘭占星（十二星）", "馬來 Ilmu Nujum", "馬來七星五刻占卜", "祖爾海", "藏傳時輪金剛",
             "九星氣學", "高棉占星", "波利尼西亞"],
