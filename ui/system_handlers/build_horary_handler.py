...
def build_horary_handler(
    *,
    compute_horary_chart,
    render_horary_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 卜卦占星 (Horary) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return render_horary_chart(**params_payload, **extra_kwargs)
    ...
    def _render(result: Any, params: BirthChartParams, options: dict[str, Any]) -> None:
        ...
        render_horary_chart(result)
        ai_button_sink("tab_horary", result, "horary", "")

    return SystemHandler(
        system_id="tab_horary",
        compute=_compute,
        render=_render,
