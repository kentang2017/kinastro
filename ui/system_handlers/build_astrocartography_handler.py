"""地點占星 (Astrocartography) Astrology handler."""
...
def build_astrocartography_handler(
    *,
    compute_astrocartography,
    render_astrocartography,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 地點占星 (Astrocartography) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_astrocartography(**params_payload, **extra_kwargs)
    ...
    def _render(result: Any, params: BirthChartParams, options: dict[str, Any]) -> None:
        ...
        render_astrocartography(
            ...
            after_chart_hook=lambda: ai_button_sink(
                "tab_astrocartography", result, "astrocartography", ""
            ),
        )

    return SystemHandler(
        system_id="tab_astrocartography",
        compute=_compute,
        render=_render,
