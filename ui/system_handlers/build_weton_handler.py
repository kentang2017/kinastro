"""爪哇 Weton (Weton) Astrology handler."""
...
def build_weton_handler(
    *,
    compute_weton,
    render_jawa_weton_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 爪哇 Weton (Weton) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_weton(**params_payload, **extra_kwargs)
