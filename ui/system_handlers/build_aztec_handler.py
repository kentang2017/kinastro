...
def build_aztec_handler(
    *,
    compute_aztec_chart,
    render_aztec_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 阿茲特克 (Aztec) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_aztec_chart(**params_payload, **extra_kwargs)
