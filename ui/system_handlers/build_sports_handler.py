...
def build_sports_handler(
    *,
    compute_sports_chart,
    render_sports_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 運動占星 (Sports) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return render_sports_astrology_chart(**params_payload, **extra_kwargs)
    ...
    def _render(result: Any, params: BirthChartParams, options: dict[str, Any]) -> None:
        ...
        render_sports_chart(result)
        ai_button_sink("tab_sports", result, "sports", "")

    return SystemHandler(
        system_id="tab_sports",
        compute=_compute,
        render=_render,
