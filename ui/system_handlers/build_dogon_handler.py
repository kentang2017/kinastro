...
def build_dogon_handler(
    *,
    compute_dogon_sirius_chart,
    render_dogon_sirius_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 多貢 (Dogon) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_dogon_sirius_chart(**params_payload, **extra_kwargs)
