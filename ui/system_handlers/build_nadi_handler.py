...
def build_nadi_handler(
    *,
    compute_nadi_chart,
    render_nadi_chart,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 納迪占星 (Nadi) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_nadi_chart(**params_payload, **extra_kwargs)
