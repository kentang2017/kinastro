"""老撾 Horasat (Lao Horasat) Astrology handler."""
...
def build_laos_handler(
    *,
    compute_lao_chart,
    render_lao_horasat,
    ai_button_sink,
) -> SystemHandler:
    """Create executable handler for 老撾 Horasat (Lao Horasat) Astrology."""
    ...
    def _cached_compute(params_payload: dict[str, Any], **extra_kwargs):
        ...
        return compute_lao_chart(**params_payload, **extra_kwargs)
